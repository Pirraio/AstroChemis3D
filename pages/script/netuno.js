...
const netunoTexture = textureLoader.load( "../img/2k_neptune.jpg" );
const raio = 1
const segmentosX = 32
const segmentosY = 32
const planetaGeometria = new THREE.SphereGeometry(raio, segmentosX, segmentosY);
const netunoMaterial = new THREE.MeshStandardMaterial({map: netunoTexture})
const netuno = new THREE.Mesh(planetaGeometria, netunoMaterial)
netuno.rotation.y = 30
scene.add(netuno)
