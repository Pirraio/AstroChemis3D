...
const marteTexture = textureLoader.load( "../img/2k_mars.jpg" );
const raio = 1
const segmentosX = 32
const segmentosY = 32
const planetaGeometria = new THREE.SphereGeometry(raio, segmentosX, segmentosY);
const marteMaterial = new THREE.MeshStandardMaterial({map: marteTexture})
const marte = new THREE.Mesh(planetaGeometria, marteMaterial)
